...
function hendleNumbersOfCards(numCards) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.post('/get-data', { numCards: numCards })];
                case 1:
                    data = (_a.sent()).data;
                    console.log(data);
                    html = '';
            ...
            if (openCard.length == 2) {
                function checkOpenedCards(openedCard) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, axios.get("/check?openFirst=" + openedCard[0] + "&openSecond=" + openedCard[1])];
                                case 1:
                                    data = (_a.sent()).data;
                                    console.log(data);
                                    if (data === true) {
