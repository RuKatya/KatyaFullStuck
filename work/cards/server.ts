...
const cards: Array<Card> = [
    { id: uuidv4(), similarNum: 1, img: "./img/1.jpg" },
    { id: uuidv4(), similarNum: 2, img: "./img/2.jpg" },
    { id: uuidv4(), similarNum: 3, img: "./img/3.jpg" },
    { id: uuidv4(), similarNum: 4, img: "./img/4.jpg" },
    { id: uuidv4(), similarNum: 5, img: "./img/5.jpg" },
    { id: uuidv4(), similarNum: 6, img: "./img/6.jpg" },
]
